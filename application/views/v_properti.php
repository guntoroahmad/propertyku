...
<div class="container-fluid mt--6">
					...
					<div class="modal-body">
						<form id="f_tambah_properti" method="post">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-12 col-sm-12">
									<div class="form-group">
										<label class="form-control-label" for="input-last-name">Developer</label>
										<input type="text" id="nama_developer" name="nama_developer" class="form-control" placeholder="Nama developer">
									</div>
								</div>
							</div>
							<div class="row">
						...
						<form id="f_edit_properti" method="post">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-12 col-sm-12">
									<div class="form-group">
										<label class="form-control-label" for="input-last-name">Developer</label>
										<input type="text" id="ed_nama_developer" name="ed_nama_developer" class="form-control" placeholder="Nama developer">
									</div>
								</div>
							</div>
							<div class="row">
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			simpan_properti();
			tampil_modal_edit();
			tampil_modal_edit_gambar();
			simpan_edit_foto_properti();
			simpan_properti_edit();
		...
		// TAMPIL EDIT GAMBAR
		function tampil_modal_edit_gambar() {
		...
		function simpan_properti() {
			$('#btn_simpan').on('click', function() {
				...
				if ($("#nama_developer").val() == "") {
					toastr.error("Nama Developer belum di isi", 'INFO');
					return false;
				};
		...
		// SIMPAN EDIT FOTO
		function simpan_edit_foto_properti() {
